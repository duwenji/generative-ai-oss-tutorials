...
#### 2.2.11.1 Python: 01_basic-indexing.py
...
##### 2.2.11.1.1 実行結果例（01_basic-indexing.py）
...
#### 2.2.11.3 Python: 03_advanced-retrieval.py
...
##### 2.2.11.3.1 実行結果例（03_advanced-retrieval.py）
...
##### 4.3.10.1.2 1. 公式リポジトリを取得（同梱 Compose を利用）
...
##### 4.6.11.1.3 2. 環境変数を設定（公式 Quickstart 準拠）
