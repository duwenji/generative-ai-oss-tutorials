...
この例では、UI・チャットアプリ基盤 の基本的な利用手順を示します。サンプルコードの意図と、実行時に何が起こるのかを確認しながら読み進めると理解しやすくなります。
...
| LibreChat | open-source AI platform | 複数Provider対応の統合会話基盤 | Agents、Tools、MCP、Artifacts | Tool Call と外部連携を重視 |
