...
prev: 09_code-generation/01_aider.md
next: 09_code-generation/03_tabby.md
---
...
## 概要
Continue は VS Code/JetBrains 向けのOSSコーディングアシスタントです。IDE内で補完、チャット、編集指示を一貫して行えます。
...
[← 前へ](09_code-generation/01_aider.md) | [次へ →](09_code-generation/03_tabby.md)
